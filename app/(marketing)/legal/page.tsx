...
export const metadata: Metadata = {
  title: "Legal Information | MineBot",
  description: "Legal information and compliance for MineBot",
};
        ...
        <section className="mt-8 space-y-6">
          <div>
            ...
            <div className="mt-2 space-y-2 text-muted-foreground">
              <p>
                <strong>Legal Name:</strong> MineBot Labs
              </p>
              <p>
          ...
          <div>
            ...
            <div className="mt-2 space-y-2 text-muted-foreground">
              <p>
                MineBot operates in compliance with applicable financial regulations and
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              ...
              MineBot or their respective owners. You may not use these marks without our prior
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              To the maximum extent permitted by law, MineBot shall not be liable for any
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              ...
              herein, constitute the entire agreement between you and MineBot regarding the use
              of our services.
            </p>
          </div>
