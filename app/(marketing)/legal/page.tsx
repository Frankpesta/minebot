...
export const metadata: Metadata = {
  title: "Legal Information | NovaxBlockPool",
  description: "Legal information and compliance for NovaxBlockPool",
};
        ...
        <section className="mt-8 space-y-6">
          <div>
            ...
            <div className="mt-2 space-y-2 text-muted-foreground">
              <p>
                <strong>Legal Name:</strong> NovaxBlockPool Labs
              </p>
              <p>
          ...
          <div>
            ...
            <div className="mt-2 space-y-2 text-muted-foreground">
              <p>
                NovaxBlockPool operates in compliance with applicable financial regulations and
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              ...
              NovaxBlockPool or their respective owners. You may not use these marks without our prior
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              To the maximum extent permitted by law, NovaxBlockPool shall not be liable for any
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              ...
              herein, constitute the entire agreement between you and NovaxBlockPool regarding the use
              of our services.
            </p>
          </div>
